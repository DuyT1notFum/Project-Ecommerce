...
const EditCategory = ({close, fetchData, data:CategoryData}) => {
  ...
  return (
    <section className='fixed z-50 top-0 bottom-0 left-0 right-0 p-4 bg-neutral-800 bg-opacity-60 flex items-center justify-center'>
            ...
            <div className='grid gap-1'>
                ...
                <div className='flex gap-4 flex-col lg:flex-row items-center'>
                    ...
                    <label htmlFor='uploadCategoryImage'>
                        <div  className={`
                        ${!data.name ? "bg-gray-400 shadow-md" : "bg-yellow-200 hover:bg-yellow-400" }  
