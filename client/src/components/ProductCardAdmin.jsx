  ...
  return (
    <div className='w-36 p-4 bg-white rounded'>
        ...
        <div className='grid grid-cols-2 gap-3 py-2'>
          ...
          border-green-600 text-green-600  hover:bg-green-600 rounded-md
           hover:text-white'>Edit</button>
          <button onClick={()=>setOpenDelete(true)} className='border px-1 py-1 text-sm border-red-600
            text-red-600 hover:bg-red-600 hover:text-white rounded-md'>Delete</button>
        </div>
            ...
            <section className='fixed top-0 left-0 right-0 bottom-0 bg-neutral-600 z-50 bg-opacity-70 p-4 flex justify-center items-center '>
                <div className='bg-white p-4 w-full max-w-md rounded-md'>
                    <div className='flex items-center justify-between gap-4'>
                        <h3 className='font-semibold'>Item Delete</h3>
                        <button className='rounded-full bg-gray-200 hover:bg-gray-400 shadow-md' onClick={()=>setOpenDelete(false)}>
                          <IoClose size={25}/>
                        </button>
                    </div>
