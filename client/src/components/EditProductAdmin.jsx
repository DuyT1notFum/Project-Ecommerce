  ...
  return (
    <section className='fixed top-0 right-0 left-0 bottom-0 bg-black z-50 bg-opacity-70 p-4'>
      <div className='bg-white w-full p-4 max-w-2xl mx-auto rounded overflow-y-auto h-full max-h-[95vh]'>
        <section className=''>
          <div className='p-2  bg-white shadow-md flex 
          fixed items-center justify-between w-[610px] 
          rounded-md'>
            <h2 className='font-semibold'>Update Product</h2>
            <button className='rounded-full bg-gray-200 
            hover:bg-gray-400' onClick={close}>
              <IoClose size={20}/>
            </button>
          </div>
            ...
            <form className='grid gap-4 mt-9' onSubmit={handleSubmit}>
              ...
              <div className='grid gap-1'>
                ...
                <textarea
                  ...
                  multiple
                  rows={3}
                  className='bg-blue-50 p-2 outline-none border focus-within:border-yellow-400 rounded resize-none'
                />
              </div>
              <div>
              ...
              <div onClick={() => setOpenAddField(true)} className=' hover:bg-yellow-500  py-1 px-3 w-32 text-center 
               font-semibold border bg-yellow-200 text-gray-400 hover:text-white cursor-pointer rounded shadow-md'>
                Add Fields
              </div>

              <button
                className='bg-yellow-200 hover:bg-yellow-400 py-2 rounded font-semibold'
              >
                Update Product
              </button>
            </form>
