   ...
   <section className='fixed top-0 bottom-0 right-0 left-0 bg-neutral-900 bg-opacity-70 z-50 flex justify-center items-center p-4'>
        <div className='bg-white rounded p-4 w-full max-w-md'>
            <div className='flex items-center justify-between gap-3'>
                ...
                hover:bg-gray-400 shadow-md" 
                onClick={close}>
                    <IoClose size={25}/>
                </button>
            </div>
            <input
                 className='bg-blue-50 my-3 p-2 border outline-none focus-within:border-yellow-400 rounded w-full '
            ...
            <button
                ...
                px-4 py-2 hover:text-white rounded-md mx-auto w-fit block'
            >Add Field</button>
        </div>
   </section>
  )
