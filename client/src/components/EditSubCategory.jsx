    ...
    bg-opacity-70 z-50 flex items-center justify-center p-4'>
        <div className='w-full max-w-5xl bg-white p-4 rounded'>
            <div className='flex items-center justify-between gap-3'>
                ...
                <button className='bg-gray-200 hover:bg-gray-400 rounded-full' onClick={close}>
                    <IoClose size={25}/>
                </button>
            </div>
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    <div className='grid gap-1'>
                        ...
                        <input 
                            ...
                            className='p-3 bg-blue-50 border outline-none focus-within:border-yellow-400 rounded-md '
                        />
                    </div>
                    <div className='grid gap-1'>
                        <p>Image</p>
                        <div className='flex flex-col lg:flex-row items-center gap-3'>
                            ...
                            <label htmlFor='uploadSubCategoryImage'>
                                <div className='px-4 py-1 border border-yellow-400 text-yellow-400 
                                rounded-sm hover:bg-yellow-400 hover:text-white cursor-pointer  '>
                                    Upload Image
                                </div>
                                <input 
                                    type='file'
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='border focus-within:border-yellow-400 rounded-md'>
                            {/*display value**/}
